  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // max-h + overflow: sem isso um formulário alto (compra de cartão com
          // a lista de etiquetas, por exemplo) passa da viewport e o botão de
          // salvar fica inalcançável, porque o popup é fixed e não rola.
